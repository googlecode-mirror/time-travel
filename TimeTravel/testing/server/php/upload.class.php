    ...
    function __construct($options=null) {
    	...
    	$this->options = array(
            ...
            'image_versions' => array(
                ...
                'optimized' => array(
                    'upload_dir' =>	(dirname(dirname(dirname(dirname(__FILE__))))) . '/pictures/'. $_SESSION['username'] .'/optimized/',
                    'upload_url' => $this->getFullUrl().'/optimized/',
                    'max_width' => 460,
                    'max_height' => 460,
                    'jpeg_quality' => 80
                ),
                ...
                'thumbnail' => array(
                	...
                	'upload_dir' =>	(dirname(dirname(dirname(dirname(__FILE__))))) . '/pictures/'. $_SESSION['username'] .'/thumbnails/',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null) {
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($file_size === $file->size) {
                ...
                //we save the picture into DB.
                $this->saveFileToDB($file_path);
