...
<div id="fbLoginDiv" class="formlabel">
	Please login into your Facebook account below so that we can retrive your statuses. <br /> <br />

	<div>
		<!-- <fb:login-button autologoutlink="true" perms="user_birthday,status_update,read_stream,offline_access"></fb:login-button> -->

		<fb:login-button size="medium" onlogin="loginToFacebook();">
